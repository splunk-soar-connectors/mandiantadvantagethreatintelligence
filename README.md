...
This table lists the configuration variables required to operate Mandiant Advantage Threat Intelligence. These variables are specified when configuring a Threat Intelligence for Splunk SOAR asset in Splunk SOAR.
